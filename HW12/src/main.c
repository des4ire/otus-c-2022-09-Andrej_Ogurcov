...
const uint8_t CR = 0x0D; //line feed symbol 
const uint8_t LF =0x0A; //carriage return symbol 
...
char hostname [20] = "telehack.com";
 ...
 int main(int argc , char *argv[]) {
  ...
  struct addrinfo hints_1, *res_1;
    ...
    freeaddrinfo(res_1); //not needed anymore  
	 ...
	 if(buffer[RX_byte-3] == CR && buffer[RX_byte-2] == LF){
	 break;	
	}
